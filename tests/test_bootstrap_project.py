...
def test_bootstrap_small_creates_expected_stage_dirs():
    ...
    try:
        ...
        for d in ("00_kickoff/project-plan",
                  ...
                  "02_design/architecture/application",
                  "02_design/architecture/application/components",
                  "02_design/architecture/application/decisions",
                  "02_design/architecture/technology",
                  "02_design/architecture/technology/decisions",
                  "02_design/architecture/data",
                  "02_design/architecture/security",
