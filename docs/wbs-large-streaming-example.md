...
| W-D-11 | 설계 승인 | user | PM | 감리 PASS + RTM | Approval Log | W-D-10 |
...
| 작업 ID | 작업 | 담당자(주) | 담당자(자문) | Input | Output | 선행 |
|--------|------|-----------|-------------|-------|--------|------|
| W-I-C-01 | 컨테이너·IaC | infrastructure-engineer | technical-architect | INF-* | `infra/{Dockerfile,compose,IaC}` | W-D-11 |
