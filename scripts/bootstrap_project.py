...
STAGE_AREAS = {
    ...
    "02_design/architecture/application": "응용 아키텍처 (AA·SWA 공동)",
    "02_design/architecture/application/components": "응용 컴포넌트 (AA)",
    "02_design/architecture/application/decisions": "응용 ADR (AA·SWA)",
    "02_design/architecture/technology": "기술 아키텍처 (TA)",
    "02_design/architecture/technology/decisions": "기술 ADR (TA)",
    "02_design/architecture/data": "데이터 아키텍처 (data-modeler)",
    "02_design/architecture/security": "보안 아키텍처 (security-specialist)",
    "02_design/db": "데이터베이스",
    "02_design/db/logical": "논리 데이터 모델",
    "02_design/db/physical": "물리 데이터 모델",
    "02_design/design-system": "디자인 시스템 (designer)",
